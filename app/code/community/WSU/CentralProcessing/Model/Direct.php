...
/**
 *
 * Centralprocessing Direct Module
 *
 * @author      jeremybass <jeremy.bass@wsu.edu>
 */
class Wsu_Centralprocessing_Model_Direct extends Mage_Payment_Model_Method_Cc
{
    protected $_code  = Wsu_Centralprocessing_Model_Config::METHOD_WPP_DIRECT;
     ...
     * @return Wsu_Centralprocessing_Model_Direct
     */
    ...
    protected function _placeOrder(Mage_Sales_Model_Order_Payment $payment, $amount)
    {
        ...
        // add line items
        $api->setPaypalCart(Mage::getModel('centralprocessing/cart', array($order)))
