 ...
 */
class Wsu_Centralprocessing_Model_Api_Nvp extends Wsu_Centralprocessing_Model_Api_Abstract
{
    /**
    ...
    const WSDL_URL_TEST = 'https://test-ewebservice.wsu.edu/CentralPaymentSite_WS/service.asmx';
    const WSDL_URL_LIVE = 'https://test-ewebservice.wsu.edu/CentralPaymentSite_WS/service.asmx';
    ...
    protected $_globalMap = array(
        ...
        // centralprocessing direct credit card information
...
// 'CURRENCYCODE' => 'currency_code',
		...
		'OneStepTranType' => 'OneStepTranType',
		'ApplicationIDPrimary' => 'ApplicationIDPrimary',
		'ReturnURL' => 'return_url',
		
		'AuthorizationAttemptLimit' => '1',
		'ApplicationIDSecondary' => 'ApplicationIDSecondary',
		'ApplicationStateData' => 'ApplicationStateData',
		'StyleSheetKey' => 'StyleSheetKey',
		'EmailAddressDeptContact' => 'email',
		'BillingAddress' => 'street',
		'BillingCity' => 'city',
		'BillingState' => 'state',
		'BillingZipCode' => 'zip',
		'BillingCountry' => 'countrycode',
		'PostBackURL' => 'giropay_success_url',
   ...
   /**
    ...
    protected function getSoapApi($options = array())
    {
        ...
        $_api = new Wsu_Centralprocessing_Model_Api_ExtendedSoapClient($wsdl, $options);
...
//        'PROFILESTARTDATE' => '_filterToPaypalDate',
    ...
    protected $_setExpressCheckoutRequest = array(
		...
		'ApplicationIDSecondary',
		'ApplicationStateData',
		'StyleSheetKey',
		'EmailAddressDeptContact',
    ...
    protected $_setExpressCheckoutResponse = array('GUID');

    /**
     * GetExpressCheckoutDetails request/response map
     * @var array
     */
    protected $_getExpressCheckoutDetailsRequest = array('GUID', 'SUBJECT',);
    ...
    protected $_doExpressCheckoutPaymentRequest = array(
        'GUID', 'PAYERID', 'PAYMENTACTION','MerchantID', 'AMT', 'CURRENCYCODE', 'IPADDRESS', 'BUTTONSOURCE', 'NOTIFYURL',
    ...
    protected $_doDirectPaymentRequest = array(
        'PAYMENTACTION','MerchantID', 'IPADDRESS', 'RETURNFMFDETAILS',
    ...
    protected $_createRecurringPaymentsProfileRequest = array(
        'GUID', 'SUBSCRIBERNAME', 'PROFILESTARTDATE', 'PROFILEREFERENCE', 'DESC', 'MAXFAILEDPAYMENTS', 'AUTOBILLAMT',
...
//    protected $_manageRecurringPaymentsProfileStatusResponse = array('PROFILEID');
    ...
    protected $_lineItemTotalExportMap = array(
        Wsu_Centralprocessing_Model_Cart::TOTAL_SUBTOTAL => 'ITEMAMT',
        Wsu_Centralprocessing_Model_Cart::TOTAL_TAX      => 'TAXAMT',
        Wsu_Centralprocessing_Model_Cart::TOTAL_SHIPPING => 'SHIPPINGAMT',
    );
    ...
    protected $_customerBillingAgreementResponse = array('GUID');

    /**
     * Billing Agreement details request/response map
     * @var array
     */
    protected $_billingAgreementCustomerDetailsRequest = array('GUID');
     ...
     * @var array
     */
    protected $_createBillingAgreementRequest = array('GUID');
     ...
     * @var array
     */
    protected $_doReferenceTransactionRequest = array('REFERENCEID', 'PAYMENTACTION','MerchantID', 'AMT', 'ITEMAMT', 'SHIPPINGAMT',
    ...
    {
        $url = $this->getUseCertAuthentication() ? 'https://api%s.centralprocessing.com/nvp' : 'https://api-3t%s.centralprocessing.com/nvp';
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_SetExpressCheckout
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_GetExpressCheckoutDetails
     */
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_DoExpressCheckoutPayment
     */
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_DoReferenceTransaction
     */
    ...
    /**
     * Made additional request to centralprocessing to get autharization id
     */
    ...
    /**
     * DoCapture call
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_DoCapture
     */
     ...
     *
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_DoAuthorization
     * @return Wsu_Centralprocessing_Model_Api_Nvp
     */
    ...
    /**
     * DoVoid call
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_DoVoid
     */
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_RefundTransaction
     */
    public function callRefundTransaction()
    {
        $request = $this->_exportToRequest($this->_refundTransactionRequest);
        if ($this->getRefundType() === Wsu_Centralprocessing_Model_Config::REFUND_TYPE_PARTIAL) {
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_ManagePendingTransactionStatus
     */
     ...
     * @link https://cms.centralprocessing.com/us/cgi-bin/?cmd=_render-content&content_ID=developer/e_howto_api_ECButtonIntegration
     */
     ...
     *
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_SetCustomerBillingAgreement
     */
     ...
     *
     * @link https://cms.centralprocessing.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/e_howto_api_nvp_r_GetBillingAgreementCustomerDetails
     */
    ...
    public function callManageRecurringPaymentsProfileStatus()
    {
        ...
        try {
            ...
            if ((in_array(11556, $this->_callErrors) && 'Cancel' === $request['ACTION'])
                ...
                Mage::throwException(Mage::helper('centralprocessing')->__('Unable to change status. Current status is not correspond to real status.'));
            }
            throw $e;
        }
    }
    ...
    public function call($methodName, array $request)
    {
		...
		$request["MerchantID"]=Mage::getStoreConfig("payment/centralprocessing_express/merchant_id", $store_id);
		$request["OneStepTranType"]=Mage::getStoreConfig("payment/centralprocessing_express/trantype", $store_id);
		$request["ApplicationIDPrimary"]=12222222;
		$request["AuthorizationAttemptLimit"]=1;

		$request["CancelURL"]="http://devstore.wsu.edu/centralprocessing/cart/";
		$request["ReturnURL"]="http://devstore.wsu.edu/centralprocessing/express/return/";
		$request["PostBackURL"]="http://devstore.wsu.edu/centralprocessing/express/return/";
 
$request["ApplicationIDSecondary"]="";
$request["ApplicationStateData"]="";
$request["StyleSheetKey"]="0eab28zs011";
$request["EmailAddressDeptContact"]="";
        ...
        try {
			...
			//$setUpUrl = $this->getApiEndpoint();
			$setUpUrl = "https://test-ewebservice.wsu.edu/CentralPaymentSite_WS/service.asmx/AuthCapRequestWithAddress";
		
            //$http->write(Zend_Http_Client::POST, $setUpUrl, '1.1', array(), $this->_buildQuery($request));		
			//$response = $http->read();
		...
		// quick prase to array
		$ob = simplexml_load_string($response);
		$json = json_encode($ob);
		$response = json_decode($json, true);

		$this->_redirectUrl = $response['WebPageURLAndGUID'];
       ...
       // $response = $this->_deformatNVP($response);
        ...
        if ($http->getErrno()) {
            Mage::logException(new Exception(
                sprintf('Centralprocessing NVP CURL connection error #%s: %s', $http->getErrno(), $http->getError())
            ));
            $http->close();

            Mage::throwException(Mage::helper('centralprocessing')->__('Unable to communicate with the Centralprocessing gateway.'));
        }
        ...
        if (!$this->_validateResponse($methodName, $response)) {
            Mage::logException(new Exception(
                Mage::helper('centralprocessing')->__("Centralprocessing response hasn't required fields.")
            ));
            Mage::throwException(Mage::helper('centralprocessing')->__('There was an error processing your order. Please contact us or try again later.'));
        }
    ...
    protected function _handleCallErrors($response)
    {
        ...
        if ($errors) {
            ...
            $e = Mage::exception('Mage_Core', sprintf('Centralprocessing NVP gateway errors: %s Correlation ID: %s. Version: %s.',
                $errors,
                isset($response['CORRELATIONID']) ? $response['CORRELATIONID'] : '',
                isset($response['VERSION']) ? $response['VERSION'] : ''
            ));
            Mage::logException($e);
            $e->setMessage(Mage::helper('centralprocessing')->__('Centralprocessing gateway has rejected request. %s', $errors));
            throw $e;
        }
    }
    ...
    protected function _exportAddressses($data)
    {
        ...
        if (isset($data['SHIPTONAME'])) {
            ...
            // Centralprocessing doesn't provide detailed shipping name fields, so the name will be overwritten
    ...
    /**
     * Convert payment status from NVP format to centralprocessing/info model format
     *
     * @param string $value
     * @return string|null
     */
    ...
    {
        switch ($value) {
            case 'None': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_NONE;
            case 'Completed': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_COMPLETED;
            case 'Denied': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_DENIED;
            case 'Expired': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_EXPIRED;
            case 'Failed': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_FAILED;
            case 'In-Progress': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_INPROGRESS;
            case 'Pending': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_PENDING;
            case 'Refunded': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_REFUNDED;
            case 'Partially-Refunded': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_REFUNDEDPART;
            case 'Reversed': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_REVERSED;
            case 'Canceled-Reversal': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_UNREVERSED;
            case 'Processed': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_PROCESSED;
            case 'Voided': return Wsu_Centralprocessing_Model_Info::PAYMENTSTATUS_VOIDED;
        }
    }
    ...
    {
        switch ($value) {
            case Wsu_Centralprocessing_Model_Pro::PAYMENT_REVIEW_ACCEPT:
                return 'Accept';
            case Wsu_Centralprocessing_Model_Pro::PAYMENT_REVIEW_DENY:
                return 'Deny';
        }
    }
