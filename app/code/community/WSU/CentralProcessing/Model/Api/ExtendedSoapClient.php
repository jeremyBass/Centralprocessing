 ...
 */
class Wsu_Centralprocessing_Model_Api_ExtendedSoapClient extends SoapClient
{
    /**
     ...
     *
     * @param int $storeId
     * @return Wsu_Centralprocessing_Model_Api_ExtendedSoapClient
     */
    ...
    {
        return Mage::getSingleton('centralprocessing/nvp');//soap');
    }
