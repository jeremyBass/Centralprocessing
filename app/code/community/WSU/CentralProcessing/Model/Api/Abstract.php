...
/**
 * Abstract class for Centralprocessing API wrappers
 *
 * @author      jeremybass <jeremy.bass@wsu.edu>
 */
abstract class Wsu_Centralprocessing_Model_Api_Abstract extends Varien_Object
{
    /**
     * Config instance
    ...
    /**
     * Centralprocessing shopping cart instance
     *
     * @var Wsu_Centralprocessing_Model_Cart
     */
   ...
   /**
    ...
    /**
     * Return Centralprocessing Api user name based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Centralprocessing Api password based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Centralprocessing Api signature based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Centralprocessing Api certificate based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Centralprocessing Api proxy status based on config data
     *
     * @return bool
     */
    ...
    /**
     * Return Centralprocessing Api proxy host based on config data
     *
     * @return string
     */
    ...
    /**
     * Return Centralprocessing Api proxy port based on config data
     *
     * @return string
     */
    ...
    /**
     * Centralprocessing page CSS getter
     *
     * @return string
     */
    ...
    /**
     * Centralprocessing page header image URL getter
     *
     * @return string
     */
    public function getHdrimg()
    {
        ...
        return $this->_getDataOrConfig('centralprocessing_hdrimg');
    }

    /**
     * Centralprocessing page header border color getter
     *
     * @return string
     */
    public function getHdrbordercolor()
    {
        ...
        return $this->_getDataOrConfig('centralprocessing_hdrbordercolor');
    }

    /**
     * Centralprocessing page header background color getter
     *
     * @return string
     */
    public function getHdrbackcolor()
    {
        ...
        return $this->_getDataOrConfig('centralprocessing_hdrbackcolor');
    }

    /**
     * Centralprocessing page "payflow color" (?) getter
     *
     * @return string
     */
    public function getPayflowcolor()
    {
        ...
        return $this->_getDataOrConfig('centralprocessing_payflowcolor');
    }
    ...
    /**
     * Centralprocessing merchant email getter
     */
    ...
    /**
     * Set Centralprocessing cart instance
     *
     * @param Wsu_Centralprocessing_Model_Cart $cart
     * @return Wsu_Centralprocessing_Model_Api_Abstract
     */
    public function setCentralprocessingCart(Wsu_Centralprocessing_Model_Cart $cart)
    {
        $this->_cart = $cart;
        return $this;
    }
     ...
     * @return Wsu_Centralprocessing_Model_Api_Abstract
     */
    public function setConfigObject(Wsu_Centralprocessing_Model_Config $config)
    {
        $this->_config = $config;
        return $this;
    }
    ...
    /**
     * region_id workaround: Centralprocessing requires state code, try to find one in the address
     *
     ...
     * Centralprocessing note: The value for quantity must be a positive integer. Null, zero, or negative numbers are not allowed.
     *
