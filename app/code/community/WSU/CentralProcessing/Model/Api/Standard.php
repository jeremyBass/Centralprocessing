...
/**
 * Centralprocessing Standard checkout request API
 */
class Wsu_Centralprocessing_Model_Api_Standard extends Wsu_Centralprocessing_Model_Api_Abstract
{
    /**
...
//        'cs' => '', // TODO
   ...
   /**
    ...
    protected $_lineItemTotalExportMap = array(
        Wsu_Centralprocessing_Model_Cart::TOTAL_SUBTOTAL => 'amount',
        Wsu_Centralprocessing_Model_Cart::TOTAL_DISCOUNT => 'discount_amount',
        Wsu_Centralprocessing_Model_Cart::TOTAL_TAX      => 'tax',
        Wsu_Centralprocessing_Model_Cart::TOTAL_SHIPPING => 'shipping',
    );
    ...
    /**
     * Generate Centralprocessing Standard checkout request fields
     ...
     * For some reason Centralprocessing ignores shipping total variables exactly when line items is enabled
     * Note that $i = 1
     *
     * @param array $request
     * @param int $i
    ...
    /**
     * Adopt specified request array to be compatible with Centralprocessing
