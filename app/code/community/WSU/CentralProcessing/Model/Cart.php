...
/**
 * Centralprocessing-specific model for shopping cart items and totals
 * The main idea is to accommodate all possible totals into Centralprocessing-compatible 4 totals and line items
 */
class Wsu_Centralprocessing_Model_Cart
{
 //   /**
//     * Totals that Centralprocessing suppports when passing shopping cart
//     *
//     * @var string
//     */
...
//     * @return Wsu_Centralprocessing_Model_Cart
//     */
...
//     *
//     * @param $setValue
//     * @return bool|Wsu_Centralprocessing_Model_Cart
//     */
...
//        Mage::dispatchEvent('centralprocessing_prepare_line_items', array('centralprocessing_cart' => $this));
//
...
//            $this->addItem(Mage::helper('centralprocessing')->__('Discount'), 1, -1.00 * $this->_totals[self::TOTAL_DISCOUNT],
...
//            $this->addItem(Mage::helper('centralprocessing')->__('Shipping'), 1, (float)$this->_totals[self::TOTAL_SHIPPING],
//                $shippingItemId
//            );
//        }
//
...
//
//    /**
//     * Check the line items and totals according to Centralprocessing business logic limitations
//     */
...
//        }
//
//        // Centralprocessing requires to have discount less than items subtotal
//        if (!$this->_isDiscountAsItem) {
...
//        }
//        // workaround in case if item subtotal precision is not compatible with Centralprocessing (.2)
//        $subAggregatedLabel = '';
