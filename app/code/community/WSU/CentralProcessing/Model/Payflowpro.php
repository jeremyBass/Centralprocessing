...
class Wsu_Centralprocessing_Model_Payflowpro extends  Mage_Payment_Model_Method_Cc
{
    /**
     ...
     */
    const TRANSACTION_URL           = 'https://payflowpro.centralprocessing.com/transaction';
    const TRANSACTION_URL_TEST_MODE = 'https://pilot-payflowpro.centralprocessing.com/transaction';
     ...
     * Payment method code
     */
    protected $_code = Wsu_Centralprocessing_Model_Config::METHOD_PAYFLOWPRO;
    ...
    public function isAvailable($quote = null)
    {
        ...
        $config = Mage::getModel('centralprocessing/config')->setStoreId($storeId);
    ...
    public function getConfigPaymentAction()
    {
        switch ($this->getConfigData('payment_action')) {
            case Wsu_Centralprocessing_Model_Config::PAYMENT_ACTION_AUTH:
                return Mage_Payment_Model_Method_Abstract::ACTION_AUTHORIZE;
            case Wsu_Centralprocessing_Model_Config::PAYMENT_ACTION_SALE:
     ...
     * @return Wsu_Centralprocessing_Model_Payflowpro
     */
    ...
    protected function _processErrors(Varien_Object $response)
    {
        if ($response->getResultCode() == self::RESPONSE_CODE_VOID_ERROR) {
            throw new Wsu_Centralprocessing_Exception(Mage::helper('centralprocessing')->__('You cannot void a verification transaction'));
    ...
    /**
     * Adopt specified address object to be compatible with Centralprocessing
