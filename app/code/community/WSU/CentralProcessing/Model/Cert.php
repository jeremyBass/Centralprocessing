...
/**
 * Centralprocessing specific model for certificate based authentication
 */
class Wsu_Centralprocessing_Model_Cert extends Mage_Core_Model_Abstract
{
    /**
     * Certificate base path
     */
    const BASEPATH_PAYPAL_CERT  = 'cert/centralprocessing';
    ...
    protected function _construct()
    {
        ...
        $this->_init('centralprocessing/cert');
    }
     ...
     * @return Wsu_Centralprocessing_Model_Cert
     */
    ...
    /**
     * Get path to Centralprocessing certificate file, if file does not exist try to create it
     *
     * @return string
     */
    public function getCertPath()
    {
        ...
        if (!$this->getContent()) {
            Mage::throwException(Mage::helper('centralprocessing')->__('Centralprocessing certificate does not exist.'));
        }
