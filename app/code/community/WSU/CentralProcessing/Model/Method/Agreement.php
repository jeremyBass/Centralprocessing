...
/**
 * Centralprocessing Billing Agreement method
 *
 * @author jeremybass <jeremy.bass@wsu.edu>
 */
class Wsu_Centralprocessing_Model_Method_Agreement extends Mage_Sales_Model_Payment_Method_Billing_AgreementAbstract
    implements Mage_Payment_Model_Billing_Agreement_MethodInterface
{
     ...
     * @var string
     */
    protected $_code = Wsu_Centralprocessing_Model_Config::METHOD_BILLING_AGREEMENT;
    ...
    /**
     * Initialize Wsu_Centralprocessing_Model_Pro model
     *
     * @param array $params
     */
    public function __construct($params = array())
    {
        ...
        if ($proInstance && ($proInstance instanceof Wsu_Centralprocessing_Model_Pro)) {
            ...
            $this->_pro = Mage::getModel('centralprocessing/pro');
        }
     ...
     * @return Wsu_Centralprocessing_Model_Method_Agreement
     */
    public function initBillingAgreementGuid(Mage_Payment_Model_Billing_AgreementAbstract $agreement)
    {
        ...
        $agreement->setRedirectUrl(
            $this->_pro->getConfig()->getStartBillingAgreementUrl($api->getGuid())
        );
        return $this;
    }

    /**
     * Retrieve billing agreement customer details by guid
     *
     * @param Mage_Payment_Model_Billing_AgreementAbstract $agreement
     * @return array
     */
    public function getBillingAgreementGuidInfo(Mage_Payment_Model_Billing_AgreementAbstract $agreement)
    {
        $api = $this->_pro->getApi()
            ->setGuid($agreement->getGuid());
        $api->callGetBillingAgreementCustomerDetails();
        $responseData = array(
            'guid'         => $api->getData('guid'),
    ...
    /**
     * Create billing agreement by guid specified in request
     *
     * @param Mage_Payment_Model_Billing_AgreementAbstract $agreement
     * @return Wsu_Centralprocessing_Model_Method_Agreement
     */
