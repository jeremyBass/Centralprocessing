...
/**
 * Fieldset renderer for Centralprocessing global settings
 * @author      jeremybass <jeremy.bass@wsu.edu>
 * @deprecated  since 1.7.0.1
 */
class Wsu_Centralprocessing_Block_Adminhtml_System_Config_Fieldset_Global
    extends Mage_Adminhtml_Block_Abstract
    implements Varien_Data_Form_Element_Renderer_Interface
{
    /**
     * Associative array of Centralprocessing product selection elements
     *
     * @var array
     */
     ...
     * @var string
     */
    protected $_template = 'centralprocessing/system/config/fieldset/global.phtml';
    ...
    {
        return Mage::helper('centralprocessing')->getElementBackendConfig($element);
    }
}
